...
function getConfigFromFlags(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { accountSid, authToken } = yield utils_3.getCredentialsFromFlags(flags, envFileVars, externalCliOptions);
        const env = utils_3.filterEnvVariablesForDeploy(envFileVars);
